    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            MyCard(
              title: Text("I love flutter", style: TextStyle(fontSize: 25.0)),
              icon: Icon(Icons.favorite, size: 40.0, color: Colors.redAccent),
            ),
            MyCard(
              title: Text("I love donuts", style: TextStyle(fontSize: 25.0)),
              icon: Icon(Icons.donut_large, size: 40.0, color: Colors.brown),
            ),
            MyCard(
              title: Text("I see you", style: TextStyle(fontSize: 25.0)),
